...
-- maneger code to corect
    managercode INT(10),
    hiredate DATE NOT NULL,
    -- SALARY DATA TYPE 
    SALRY INT(10) NOT NULL,
    COMMISION INT(10),
    ...
    -- ADD COLUMN FIRST
    ALTER TABLE EMPLOYEE 
    ADD COLUMN managerFNAME VARCHAR(50)
    FIRST;
    -- REMOVE
    ALTER TABLE EMPLOYEE
    ...
    -- RENAME 
    ALTER TABLE 
    CHANGE COLUMN COMMISION designation INT(10);
    -- rename 
    ALTER TABLE 
    CHANGE COLUMN managercode ROHIT INT(8);
-- CONSTRAINS
-- ADD REMOVE MODIFY
ALTER TABLE EMPLOYEE
CHANGE COLUMN employeecode employeecode INT(4) UNIQUE NOT NULL;
-- REMOVE
    ALTER TABLE employee
            CHANGE COLUMN  Salry Salry FLOAT; 
